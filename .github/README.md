...
[`@aws-sdk/client-wellarchitected`](https://www.npmjs.com/package/@aws-sdk/client-wellarchitected/v/3.100.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-wellarchitected@3.100.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-rLhIDpbWBVwWwNum6y+tXtjWhicwa2Ce/sIHaUUFs+WtSTzh3rawR1UJct5nr2Yc
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-wellarchitected": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-wellarchitected@3.100.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-wellarchitected@3.100.0/index.min.mjs": "sha384-rLhIDpbWBVwWwNum6y+tXtjWhicwa2Ce/sIHaUUFs+WtSTzh3rawR1UJct5nr2Yc"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-wellarchitected/blob/refs/tags/3.100.0/LICENSE
```
